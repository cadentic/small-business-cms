<template>
    ...
    >
        ...
        <v-list dense nav>
            ...
            <v-tooltip right nudge-bottom="60" :disabled="!mini_v1" color="black">
                <template v-slot:activator="{ on }">
