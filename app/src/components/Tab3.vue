                ...
                <v-row no-gutters>
                    <v-col cols="10">
                        ...
                        <div class="bottomLeft" v-if="editorActive" >
                            ...
                            <div style="z-index: 2; position: fixed; bottom: 0px; padding: 0.5em 2em; width: 36%;background: white;border: 1px solid #ddd;"><v-btn>Submit</v-btn></div>
                        </div>
                    </v-col>
                    <v-col cols="2">
                    ...
                    <v-expansion-panels
                        ...
                        <v-expansion-panel  style="margin-bottom: 3em">
                            <v-expansion-panel-header class="knowledge-link-title">
                                ...
                                <span>Technical Service Requests</span>
                                ...
                                <div class="service-request-contents technical-service-content position-relative">
                                    ...
                                    <v-row no-gutters>
                                        <v-col cols="8">
                                            ...
                                            <div class="left-technical-btn d-block d-md-inline float-md-left mt-2 ml-2">
                                                <v-btn @click="showEditor">Create Technical SR</v-btn>
                                            </div>
                                    ...
                                    <div class="service-request-options">
                                        <table class="service-request-table">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><a href="#">*we need sales lead and local contact details for lead generation</a></td>
                                                <td><a href="#">3-20563867436</a></td>
                                                ...
                                                <td><a href="#"><i class="fa fa-exclamation-triangle"></i>Solution Offered</a></td>
                                                <td><a href="#">10+ Hours Ago</a></td>
                    ...
                    <v-expansion-panels focusable>
                        <v-expansion-panel>
                            <v-expansion-panel-header class="knowledge-link-title">
                                ...
                                <span>Non-Technical Service Requests</span>
                                <div class="right-gear-icon">
                                    <i class="fa fa-cog"></i>
                                    <i class="fa fa-sort-down"></i>
                                </div>
