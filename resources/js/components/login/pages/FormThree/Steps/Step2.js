    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <TextField
          ...
          variant="outlined"
          fullWidth
          error={!model.business && model.business !== undefined}
          onChange={e => handleChange(e)}
        />
      </Grid>
      <Grid item xs={12}>
        <TextField
          ...
          type="text"
          label="CIN Number"
          value={model.cinNumber}
          name="cinNumber"
          margin="normal"
          variant="outlined"
          fullWidth
          error={!model.cinNumber && model.cinNumber !== undefined}
          onChange={e => handleChange(e)}
        />
      </Grid>
      <Grid item xs={12}>
        <TextField
          required
          type="text"
          label="Tax Number (VAT/GST)"
          value={model.taxNumber}
          name="taxNumber"
          margin="normal"
          variant="outlined"
          fullWidth
          error={!model.taxNumber && model.taxNumber !== undefined}
          onChange={e => handleChange(e)}
        />
      </Grid>
      <Grid item xs={12}>
