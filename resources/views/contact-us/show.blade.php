...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('assets/css/jquery-multitabs.css') }}" rel="stylesheet" media="all" />
        <link href="{{ asset('assets/css/animate.css') }}" rel="stylesheet" media="all" />
        ...
        <link href="{{ asset('assets/css/crafted.css') }}" rel="stylesheet" media="all" />
    ...
    <body>
        <div id="app">
            ...
            <contactdetailscomponent ticket="{{ $ticket_id }}"></contactdetailscomponent>
        </div>
